...
const Footer = () => (
  <section id="Contact" className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      <div className="flex-1 flex flex-col justify-start mr-10 items-start">
        <img src={pfp} alt="pfp" className="w-[266px] h-[266px] object-cover rounded-full" />
        <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>Here you have some useful information about me.</p>
      </div>
